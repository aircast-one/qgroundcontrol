...
if(NOT DEFINED QGC_TEST_RUNNER_TARGET)
    set(QGC_TEST_RUNNER_TARGET ${CMAKE_PROJECT_NAME})
endif()
...
function(add_qgc_test test_name)
    ...
    if(QGC_BUILD_TEST_BINARY AND TARGET qgc_tests)
        ...
        set(_test_command $<TARGET_FILE:${QGC_TEST_RUNNER_TARGET}> --unittest:${test_name} --allow-multiple)
    endif()
