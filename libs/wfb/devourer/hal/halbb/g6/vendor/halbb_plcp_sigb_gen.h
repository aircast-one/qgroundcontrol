...
#ifndef _HALBB_PLCP_SIGB_GEN_H_
#define _HALBB_PLCP_SIGB_GEN_H_

#define NUM_RU_SIZE 6
#define NUM_SUB20_P 4
#define MAX_DATA_STACK_SIZE 9
#define MAX_UB_NUM 5
#define EMPTY_UF 0x0FFC01

static const u8 msb2lsb_tab16[16] = {0, 8, 4, 12, 2, 10, 6, 14, 1, 9, 5, 13, 3, 11, 7, 15};

static const u8 crctab_mp[256] = {
