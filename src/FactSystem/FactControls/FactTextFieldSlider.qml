...
Rectangle {
    ...
    property var  _sliderMin:               sliderMin !== undefined ? sliderMin : (fact && fact.userMin !== undefined ? fact.userMin : (fact && allowUsingMinMax ? fact.min : undefined))
    property var  _sliderMax:               sliderMax !== undefined ? sliderMax : (fact && fact.userMax !== undefined ? fact.userMax : (fact && allowUsingMinMax ? fact.max : undefined))
    ...
    Component.onCompleted: {
        _loadComplete = true
        if (fact && warnOnUserMinMaxInvalid && !allowUsingMinMax && sliderMin === undefined && sliderMax === undefined && (fact.userMin === undefined || fact.userMax === undefined)) {
