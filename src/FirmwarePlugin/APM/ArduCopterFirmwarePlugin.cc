    ...
    : APMFirmwarePlugin(parent)
{
    ...
    static FlightModeList availableFlightModes = {
        { _stabilizeFlightMode   , APMCopterMode::STABILIZE,     true , false },
        { _acroFlightMode        , APMCopterMode::ACRO,          true , true },
        { _altHoldFlightMode     , APMCopterMode::ALT_HOLD,      true , false },
        { _autoFlightMode        , APMCopterMode::AUTO,          true , false },
        { _guidedFlightMode      , APMCopterMode::GUIDED,        true , false },
        { _loiterFlightMode      , APMCopterMode::LOITER,        true , false },
        { _rtlFlightMode         , APMCopterMode::RTL,           true , false },
        { _circleFlightMode      , APMCopterMode::CIRCLE,        true , true },
        { _landFlightMode        , APMCopterMode::LAND,          true , false },
        ...
        { _posHoldFlightMode     , APMCopterMode::POS_HOLD,      true , false },
