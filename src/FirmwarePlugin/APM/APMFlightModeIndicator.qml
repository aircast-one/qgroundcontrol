...
SettingsGroupLayout {
    ...
    readonly property bool _hasRtlAlt: controller.parameterExists(-1, "RTL_ALT_M")
    property Fact rtlAltFact: _hasRtlAlt ? controller.getParameterFact(-1, "RTL_ALT_M") : null
