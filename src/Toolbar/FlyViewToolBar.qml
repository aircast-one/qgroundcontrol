...
Item {
    ...
    id:     control
    width:  parent.width
    height: Math.max(ScreenTools.toolbarHeight, _dockedBarHeight)

    property Item dockedTelemetryBar

    readonly property real dockAreaLeft:    leftPanel.width
    readonly property real dockAreaRight:   control.width - rightPanel.width
