...
Item {
    ...
    property int  _globalAltMode:           missionItem.masterController.missionController.globalAltitudeFrame
    property bool _globalAltModeIsMixed:    _globalAltMode == QGroundControl.AltitudeFrameMixed
    property real _radius:                  ScreenTools.defaultFontPixelWidth / 2
    property real _fieldWidth:              ScreenTools.defaultFontPixelWidth * 12

    readonly property string _altModeText: QGroundControl.altitudeFrameShortDescription(missionItem.altitudeFrame)
    ...
    ColumnLayout {
        ...
        SettingsGroupLayout {
            ...
            description:        missionItem.isLandCommand
                                    ...
                                    : (missionItem.altitudeFrame === QGroundControl.AltitudeFrameCalcAboveTerrain
            ...
            RowLayout {
                ...
                visible:                _globalAltMode !== QGroundControl.AltitudeFrameRelative
                ...
                AltModeMenu {
                    ...
                    currentAltMode:  missionItem.altitudeFrame
                    rgRemoveModes:   _controllerVehicle.supports.terrainFrame
                                        ? [QGroundControl.AltitudeFrameMixed]
                                        : [QGroundControl.AltitudeFrameMixed, QGroundControl.AltitudeFrameTerrain]
                    updateAltModeFn: (altMode) => { missionItem.altitudeFrame = altMode }
                }
            }
        }
