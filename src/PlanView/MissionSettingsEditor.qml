...
Item {
    ...
    Connections {
        target: _controllerVehicle ? _controllerVehicle.supports : null
        function onTerrainFrameChanged() {
            if (!_controllerVehicle.supports.terrainFrame && _missionController.globalAltitudeFrame === QGroundControl.AltitudeFrameTerrain) {
                _missionController.globalAltitudeFrame = QGroundControl.AltitudeFrameCalcAboveTerrain
            }
        }
    }
        ...
        SettingsGroupLayout {
            ...
            RowLayout {
                ...
                QGCLabel {
                    id:                 altModeLabel
                    Layout.alignment:   Qt.AlignVCenter
                    text:               QGroundControl.altitudeFrameShortDescription(_missionController.globalAltitudeFrame)
                ...
                AltModeMenu {
                    ...
                    currentAltMode:  _missionController.globalAltitudeFrame
                    rgRemoveModes:   _controllerVehicle.supports.terrainFrame ? [] : [QGroundControl.AltitudeFrameTerrain]
                    rgDisableModes:  _noMissionItemsAdded
                                        ? []
                                        : [QGroundControl.AltitudeFrameRelative,
                                           QGroundControl.AltitudeFrameAbsolute,
                                           QGroundControl.AltitudeFrameCalcAboveTerrain,
                                           QGroundControl.AltitudeFrameTerrain]
                    updateAltModeFn: (altMode) => { _missionController.globalAltitudeFrame = altMode }
                }
            }
