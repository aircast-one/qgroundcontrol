...
{
    SettingsManager::instance()->appSettings()->clearSettingsNextBoot()->setRawValue(true);
}

void QGroundControlQmlGlobal::clearDeleteAllSettingsNextBoot()
{
    SettingsManager::instance()->appSettings()->clearSettingsNextBoot()->setRawValue(false);
}
