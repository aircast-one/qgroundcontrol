...
OverlayCapsule {
    ...
    readonly property real _ringSize: ScreenTools.defaultFontPixelHeight * 1.1
    ...
    Canvas {
        ...
        width:                  _root._ringSize
        height:                 width
        rotation:               _root.progress < 0 && !_root.done ? angle : 0
        ...
        Connections {
            ...
            function onDoneChanged()         { ring.requestPaint() }
            function onContentColorChanged() { ring.requestPaint() }
        }
    }
