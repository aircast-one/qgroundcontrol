...
SetupPage {
    ...
    Component {
        ...
        Item {
            ...
            readonly property int mainTextH1PointSize: ScreenTools.mediumFontPointSize
            ...
            property Fact   _compassAutoRotFact:            controller.getParameterFact(-1, "COMPASS_AUTO_ROT", false )
