...
ListModel {
    ...
    ListElement {
        name: qsTr("3D View")
        summary: qsTr("Buildings, terrain, 3D map")
        //: Comma-separated search terms for this settings page. Translate the words a
        //: user would type to look for these settings; keep product names as-is.
        keywords: qsTr("3d, view, osm, building, height, terrain, map")
        section: ""
    ...
    ListElement {
        name: qsTr("NTRIP / RTK")
        summary: qsTr("RTK corrections over NTRIP")
        //: Comma-separated search terms for this settings page. Translate the words a
        //: user would type to look for these settings; keep product names as-is.
        keywords: qsTr("ntrip, rtk, rtcm, gps, corrections, caster, mountpoint, base, station")
        section: ""
    ...
    ListElement {
        name: qsTr("App Logging")
        summary: qsTr("Log categories and console output")
        //: Comma-separated search terms for this settings page. Translate the words a
        //: user would type to look for these settings; keep product names as-is.
        keywords: qsTr("log, logging, category, debug, console, file")
        section: ""
